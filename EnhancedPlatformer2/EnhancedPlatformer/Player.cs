...
namespace EnhancedPlatformer
{
    ...
    class Player
    {
        ...
        private SoundEffect poisonedSound;
        ...
        private const float MaxSickSpeed = 150.0f;
        ...
        public void LoadContent()
        {
            ...
            idleAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/IdleAya"), 0.1f, true);
            runAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/RunAya"), 0.1f, true);
            ...
            poisonedSound = Level.Content.Load<SoundEffect>("Sounds/Ill");
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (IsPoisoned)
                poisonedTime = Math.Max(0.0f, poisonedTime - (float)gameTime.ElapsedGameTime.TotalSeconds);
        ...
        public void ApplyPhysics(GameTime gameTime)
        {
            ...
            if(IsPoisoned)
                velocity.X = MathHelper.Clamp(velocity.X, -MaxSickSpeed, MaxSickSpeed);
            else
        ...
        public void PowerUp()
        {
            ...
            else
            {
                ...
                currentEffect = powerUpSound.Play();
            }
        }
        ...
        public void Poisoned()
        {
            ...
            {
                poisonedTime = MaxPowerUpTime;
                currentEffect = poisonedSound.Play();
            }
        }
    }
}
